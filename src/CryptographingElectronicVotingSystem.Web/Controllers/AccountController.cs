...
namespace CryptographingElectronicVotingSystem.Web.Controllers
{
    ...
    public partial class AccountController : Controller
    {
        ...
        public AccountController(ApplicationIdentityDbContext context, IWebHostEnvironment env, SignInManager<ApplicationUser> signInManager, UserManager<ApplicationUser> userManager,
        ...
        public async Task<IActionResult> Login(string userName, string password, string redirectUrl)
        {
            ...
            if (!string.IsNullOrEmpty(userName) && !string.IsNullOrEmpty(password))
            {
                ...
                if (result.RequiresTwoFactor)
                {
                    ...
                    var text = $@"Hi, <br /> <br />
We received your request for a single-use code to use with your TestRadzen account. <br /> <br />
        ...
        public async Task<IActionResult> Register(string userName, string password)
        {
            ...
            if (result.Succeeded)
            {
                try
                {
                    ...
                    var text = $@"Hi, <br /> <br />
We received your registration request for TestRadzen. <br /> <br />
