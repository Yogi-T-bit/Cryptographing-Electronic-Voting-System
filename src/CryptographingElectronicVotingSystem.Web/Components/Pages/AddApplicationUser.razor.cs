...
namespace CryptographingElectronicVotingSystem.Web.Components.Pages
{
    public partial class AddApplicationUser
    {
        ...
        protected CryptographingElectronicVotingSystem.Dal.Models.Authentication.ApplicationUser user;
        ...
        {
            user = new CryptographingElectronicVotingSystem.Dal.Models.Authentication.ApplicationUser();

            roles = await Security.GetRoles();
        }

        protected async Task FormSubmit(CryptographingElectronicVotingSystem.Dal.Models.Authentication.ApplicationUser user)
        {
            try
            {
