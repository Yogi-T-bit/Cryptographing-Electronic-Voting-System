...
namespace CryptographingElectronicVotingSystem.Web.Components.Pages
{
    public partial class Votes
    {
        ...
        protected IEnumerable<CryptographingElectronicVotingSystem.Dal.Models.ElectronicVotingSystem.vote> votes;

        protected RadzenDataGrid<CryptographingElectronicVotingSystem.Dal.Models.ElectronicVotingSystem.vote> grid0;
        ...
        protected async Task EditRow(DataGridRowMouseEventArgs<CryptographingElectronicVotingSystem.Dal.Models.ElectronicVotingSystem.vote> args)
        {
            await DialogService.OpenAsync<EditVote>("Edit vote", new Dictionary<string, object> { {"VoteID", args.Data.VoteID} });
        }

        protected async Task GridDeleteButtonClick(MouseEventArgs args, CryptographingElectronicVotingSystem.Dal.Models.ElectronicVotingSystem.vote vote)
        {
            try
            {
