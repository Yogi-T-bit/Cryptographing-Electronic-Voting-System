...
namespace CryptographingElectronicVotingSystem.Web.Components.Pages
{
    public partial class ApplicationRoles
    {
        ...
        protected RadzenDataGrid<CryptographingElectronicVotingSystem.Dal.Models.Authentication.ApplicationRole> grid0;
        ...
        protected async Task DeleteClick(CryptographingElectronicVotingSystem.Dal.Models.Authentication.ApplicationRole role)
        {
            try
            {
