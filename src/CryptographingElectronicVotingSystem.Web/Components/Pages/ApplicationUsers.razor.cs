...
namespace CryptographingElectronicVotingSystem.Web.Components.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<CryptographingElectronicVotingSystem.Dal.Models.Authentication.ApplicationUser> users;
        protected RadzenDataGrid<CryptographingElectronicVotingSystem.Dal.Models.Authentication.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(CryptographingElectronicVotingSystem.Dal.Models.Authentication.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(CryptographingElectronicVotingSystem.Dal.Models.Authentication.ApplicationUser user)
        {
            try
            {
